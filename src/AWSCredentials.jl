...
# Returns
- `AWSCredentials`: Default AWS Credentials or ones for the specified profile
"""
...
# Returns
- `Bool`: True if running the machine executing this is an EC2 instance
"""
...
"""
    check_credentials(aws_creds::AWSCredentials, force_refresh::Bool=false)
...
# Returns
- `String`: EC2 Metadata request body, or `nothing` if the endpoint cannot be accessed (not
...
# Returns
- `AWSCredentials`: AWSCredentials from EC2 metadata
"""
...
Retrieve the `AWS_ACCESS_KEY_ID` and `AWS_SECRET_ACCESS_KEY` from their environment
variables.

# Returns
- `AWSCredentials`: AWSCredentials, or `nothing` if they could not be found
"""
...
# Returns
- `AWSCredentials`: AWSCredentials, or `nothing` if credentials could not be found
"""
...
# Returns
- `Tuple`: AWS Access Key ID, AWS Secret Access Key, AWS Session Token
"""
...
Retrieve the user ARN from the `AWSConfig`, if not present query Security Token Services
(STS).
...
# Returns
- `AWSCredentials`: AWSCredentials from STS
"""
...
# Returns
- `Tuple`: Source profile and Role ARN
"""
